...
<body class="bg-gray-100">
	<div class="container mx-auto py-8">
		<form action="dashboardguru.php" method="GET" class="mb-4">
	...
	<h1> Data Guru </h1>
		<nav>
			<div>
				<a href="../../guru/view/tambah.php" class="btn bg-blue-500 text-white">Tambah Data Guru</a>
				<a href="../../guru/view/cetak.php" target="_blank" class="btn bg-blue-500 text-white">Cetak</a>
			</div>
            <div>
	...
	<table border="1">
			<?php  
				if (isset($_GET['cari'])) {
					$cari = $_GET['cari'];
					$ambildata = mysqli_query($kon, "SELECT * FROM guru WHERE idguru LIKE '%".$cari."%' OR nama LIKE '%".$cari."%'");
				} else {
		...
		<?php  
			while ($userAmbilData = mysqli_fetch_array($ambildata)) {
				echo "<tr>";
					echo "<td class='border border-gray-400 px-4 py-2'>" . $idguru = $userAmbilData['idguru'] . "</td>";
					...
					echo "<td class='border border-gray-400 px-4 py-2'> 
							<a href='../../guru/view/view.php?idguru=" . $userAmbilData['idguru'] . "' class='btn btn-view'> View </a> | 
							<a href='../../guru/view/update.php?idguru=" . $userAmbilData['idguru'] . "' class='btn btn-edit'> Edit </a> |
							<a href='../../guru/Controller/guruhapus.php?idguru=" . $userAmbilData['idguru'] ."' class='btn btn-hapus'> Hapus </a>  
						</td>";
				echo "</tr>";
			}
		?>
